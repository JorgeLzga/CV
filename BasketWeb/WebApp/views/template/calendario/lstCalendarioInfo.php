    ...
    <main>
        ...
        <div class="body-text">
            ...
            <div class="d-flex flex-column flex-sm-row">
                <a href="infoCalendario.php?idTorneo=<?= $lstTorneo['idTorneo']?>" 
                    class="btn button-terracota mb-2 mb-sm-0 mr-sm-2 mx-2"><i class="fa-solid fa-angle-left"></i> Regresar al Calendario</a>
            </div>
                                        ...
                                        <div class="card h-100 shadow border-0 elevate-card rounded-top">
                                            ...
                                            <div class="card-footer border-0">
                                                <td style="vertical-align: middle;">
                                                   <a href="../jornada/infoJornada.php?idTorneo=<?= $partido['idTorneo'] ?>&idCalendario=<?= $partido['idCalendario']?>&vFecha=<?= $fechaSeleccionada ?>" title="Ver Partido"><i class="fa-solid fa-list-check size-icon text-desert"></i></a>
                                                </td>&ensp;
                                                <td style="vertical-align: middle;">
                                                <a href="frmEditCalendario.php?idTorneo=<?= $partido['idTorneo'] ?>&idCalendario=<?= $partido['idCalendario']?>&vFecha=<?= $fechaSeleccionada ?>" title="Editar Partido" >
                                                    <i class="fa-solid fa-pen-to-square size-icon text-desert"></i></a>
                                                </td>&ensp;
                                                <td style="vertical-align: middle;">
                                                    <a href="../calendario/delateCalendario.php?idTorneo=<?= $partido['idTorneo'] ?>&idCalendario=<?= $partido['idCalendario']?>" title="Eliminar Partido">
                                                    <i class="fas fa-delete-left size-icon text-desert"></i></a>
                                                </td>&ensp;
                                            </div>                            
                                        </div>
                                    </div>
