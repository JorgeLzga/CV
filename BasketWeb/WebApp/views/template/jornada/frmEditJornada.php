        ...
        <div class="body-text">
            ...
            <?php
                ...
                if (isset($_GET['success'])) {
                    ...
                    if ($success === 'updated') {
                        ...
                        $_SESSION['success_message'] = '<a href="frmEditJornada.php?idTorneo='. $lstTorneo['idTorneo'] .'&idCalendario='.$idCalendario.'&vFecha='.$fechaSeleccionada.'" class="text-decoration-none" style="color: #0A3622">
                                                        <i class="fa-solid fa-check"></i> El resultado se ha acutalizado correctamente.</a>';
            ...
            <div class="d-flex flex-column flex-sm-row">
                <a href="infoJornada.php?idTorneo=<?= $lstTorneo['idTorneo']?>&idCalendario=<?= !empty($lstJornadaEquipoLocal) ? $lstJornadaEquipoLocal[0]['idCalendario'] : '' ?>&vFecha=<?= $fechaSeleccionada ?>" 
                    class="btn button-terracota mb-2 mb-sm-0 mr-sm-2 mx-2"><i class="fa-solid fa-angle-left"></i> Regresar a Resultado</a>
                        ...
                        <div class="card h-100 shadow border-0 elevate-card rounded-top">
                            ...
                            <div class="card-body" style="padding: 15px 35px 15px 35px;">
                                ...
                                <div class="table-responsive">
                                    <form action="updateJornada.php" method="POST">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width: 20%;" class="border-0 text-start">
                                                        <input class="form-control text-center border-0" type="number" 
                                                            name="jugadores[<?= $index ?>][vPuntosTotal]" 
                                                    ...
                                                    <input type="hidden" name="jugadores[<?= $index ?>][idCalendario]" value="<?= $JornadaEqLocal['idCalendario'] ?>">
                                                    <input type="hidden" name="jugadores[<?= $index ?>][idHistoriCoJugador]" value="<?= $JornadaEqLocal['idHistoriCoJugador'] ?>">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            <input  type="submit" class="btn button-terracota" value="Actualizar Resultados">
                                        </div>
                                    </form>
                                </div>
                            </div>
                                        ...
                                        <table class="table text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="jugadores[<?= $index ?>][idHistoriCoJugador]" value="<?= $JornadaEqVisitante['idHistoriCoJugador'] ?>">
