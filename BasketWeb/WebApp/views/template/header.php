...
if ($isAuthenticated) {
    ...
    if (isset($_SESSION['vUsuario'])) {
        ...
        $torneoActual = $objTorneosControllador->mostrarTorneosDelAdministrador($idTorneo);
    }
}
?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark p-3 shadow" aria-label="Eighth navbar example">
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarsHeader">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <?php foreach($torneoActual AS $torneoAd):?>
                        <li class="nav-item">
                            <a class="nav-link text-terracota" 
                                href="/WebApp/views/template/torneo/infoTorneo.php?idTorneo=<?= $torneoAd['idTorneo'] ?>">Torneo</a>
                        </li>
                        <?php endforeach;?>
                        ...
                        <?php foreach($torneoActual AS $torneoAdm):?>

                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-terracota" href="#" data-bs-toggle="dropdown" aria-expanded="false">Agregar</a>
                            <ul class="dropdown-menu text-small">
                                <li><a class="dropdown-item" href="/WebApp/views/template/grupo/frmGrupo.php?idTorneo=<?= $torneoAdm['idTorneo']?>  ">Agregar Grupo</a></li>
                                <li><a class="dropdown-item" href="/WebApp/views/template/equipo/frmEquipoDirect.php?idTorneo=<?= $torneoAdm['idTorneo']?>">Agregar Equipo</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu text-small">
                                <li><a class="dropdown-item" href="/WebApp/views/template/calendario/infoCalendario.php?idTorneo=<?= $torneoAdm['idTorneo']?>">Ver Calendario</a></li>
                                <li><a class="dropdown-item" href="/WebApp/views/template/calendario/frmCalendario.php?idTorneo=<?= $torneoAdm['idTorneo']?>">Agregar Calendario</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu text-small">
                                <li><a class="dropdown-item" href="/WebApp/views/template/estEquipo/lstEstEquipo.php?idTorneo=<?= $torneoAdm['idTorneo']?>">Equipos</a></li>
                                <li><a class="dropdown-item" href="/WebApp/views/template/estJugador/lstEstJugador.php?idTorneo=<?= $torneoAdm['idTorneo']?>">Jugadores</a></li>
                            </ul>
                        </li>
                    <?php endforeach;?>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu text-small">
                                ...
                                <li><a class="dropdown-item" href="#">Agregar Jugadores</a></li>
                            </ul>
                        </li>
                        <?php endforeach; ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu text-small">
                                ...
                                <li><a class="dropdown-item" href="/WebApp/views/template/calendario/frmCalendario.php?idTorneo=<?= $torneo['idTorneo'] ?>">Agregar</a></li>
                            </ul>
                        </li>
