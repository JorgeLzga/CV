    ...
    <main>
        ...
        <div class="body-text">
            ...
            <div class="d-flex flex-column flex-sm-row">
                <a href="lstCalendarioUsuario.php?idTorneo=<?= $lstTorneo['idTorneo'] ?>&vFecha=<?= $fechaSeleccionada ?>" 
            ...
            <div class="row justify-content-center ">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    href="infoEquipoUsuario.php?idTorneo=<?= $lstTorneo['idTorneo']?>&idEquipo=<?= !empty($lstJornadaEquipoLocal) ? $lstJornadaEquipoLocal[1]['idEquipo'] : "Sin Nombre"?>">
                ...
                <div class="col-md-6 mb-3">
                    <a class="text-decoration-none"
                    href="infoEquipoUsuario.php?idTorneo=<?= $lstTorneo['idTorneo']?>&idEquipo=<?= !empty($lstJornadaEquipoVisitante) ? $lstJornadaEquipoVisitante[1]['idEquipo'] : "Sin Nombre" ?>">
                    <div class="text-decoration-none text-reset">
                        <div class="card h-100 shadow border-0 elevate-card rounded-top">
                            <div class="border-0"></div>
                            <div class="card-body" style="padding: 15px 35px 15px 35px;">
